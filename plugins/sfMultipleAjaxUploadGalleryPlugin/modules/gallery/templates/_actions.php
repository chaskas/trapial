...
<?php if(!$photo->getIsDefault()){ ?>
    <a href="#" onclick="ajaxPhotoEdition('<?php echo url_for('photo_ajax_default', $photo) ?>')" class="default"><img src="/sfMultipleAjaxUploadGalleryPlugin/images/setdefault.png" title="<?php echo __("Utilizar como portada");?>"/></a>
<?php } ?>
...
<a href="#" onclick="ajaxPhotoEdition('<?php echo url_for('photo_ajax_delete', $photo) ?>')" class="delete"><img src="/sfMultipleAjaxUploadGalleryPlugin/images/trash.png" title="<?php echo __("Eliminar");?>"/></a>
